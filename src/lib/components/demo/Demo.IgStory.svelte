<script>
	 ...
	 */
	import Chapters from "$lib/components/demo/Demo.IgStory.Chapters.svelte";
	import Figure from "$lib/components/demo/Demo.IgStory.Figure.svelte";
	import Tap from "$lib/components/helpers/Tap.svelte";
